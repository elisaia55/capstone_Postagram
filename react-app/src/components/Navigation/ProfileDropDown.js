...
function ProfileDropDown() {
    ...
    return (
        <div className="dropdown-menu-container">
            <a className="dropdown-a-tags" href={`/users/${user}`}>
